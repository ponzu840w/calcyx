...
static const struct { const char *name; const char *desc; } DOCS[] = {
    ...
    // 色変換
    { "rgb",         "Generates 24 bit colour value from R, G, B." },
    { "hsv2rgb",     "Converts from H, S, V to 24 bit RGB colour value." },
    { "rgb2hsv",     "Converts the 24 bit RGB colour value to HSV." },
    { "hsl2rgb",     "Converts from H, S, L to 24 bit colour RGB value." },
    { "rgb2hsl",     "Converts the 24 bit RGB colour value to HSL." },
    { "rgb2yuv",     "Converts 24bit RGB colour to 24 bit YUV." },
    { "yuv2rgb",     "Converts the 24 bit YUV colour to 24 bit RGB." },
    { "rgbTo565",    "Downconverts RGB888 colour to RGB565." },
    { "rgbFrom565",  "Upconverts RGB565 colour to RGB888." },
    { "pack565",     "Packs the 3 values to an RGB565 colour." },
    { "unpack565",   "Unpacks the RGB565 colour to 3 values." },
    // ECC / パリティ
